...
The assignment code, data distributions, and reports are systematically organized as follows:

```text
├── 📁 Assignment-01/   # based on Python Programming and Statistical Concepts
├── 📁 Assignment-02/   # based on Python Data Analysis Packages
├── 📁 Assignment-03/   # based on EDA, Data Cleaning & Outlier Treatment and ect
├── 📁 Assignment-04/
├── 📁 Assignment-05/
├── 📁 Assignment-06/
